  ...
  const[userData, setUserData]=useState({
    ...
    const handleSubmit = (e)=>{
      ...
      if(status===STATUSES.SUCCESS){
        ...
        alert("Error occurred during loginn. Please try again.")
        return
      }else{
        alert("Login is in progress. Please wait.")
      }
    }
  return (
    <div className="flex min-h-screen items-center justify-center bg-yellow-50 px-6 py-12">
      <div className="w-full max-w-2xl bg-white shadow-3xl">
        ...
        <form className="p-3 md:p-10">
          <div className="flex items-center mb-6 text-lg md:mb-8">
            ...
            <input onChange={handleChange} type="email" id="username" name="userEmail" className="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="Username" />
          </div>
          <div className="flex items-center mb-6 text-lg md:mb-8">
            <svg className="absolute ml-3" viewBox="0 0 24 24" width="24">
              <path d="m18.75 9h-.75v-3c0-3.309-2.691-6-6-6s-6 2.691-6 6v3h-.75c-1.24 0-2.25 1.009-2.25 2.25v10.5c0 1.241 1.01 2.25 2.25 2.25h13.5c1.24 0 2.25-1.009 2.25-2.25v-10.5c0-1.241-1.01-2.25-2.25-2.25zm-10.75-3c0-2.206 1.794-4 4-4s4 1.794 4 4v3h-8zm5 10.722v2.278c0 .552-.447 1-1 1s-1-.448-1-1v-2.278c-.595-.347-1-.985-1-1.722 0-1.103.897-2 2-2s２ .897 ２ ２c0 .737-.405 １．３７５－１．７２２z"/>
            </svg>
